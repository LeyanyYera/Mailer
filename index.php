...
<head>
    ...
    <meta name="description" content="Alegria">
...
<body>
    <div class="" style="background-color: #00933D; height: 1000px; width: 750px; margin-left: 20%; position: absolute;">
        <div class="row">
            <div class="col-sm-12 text-center">
                <img src="images/Cabezal.png" style="width: 96%;"/>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div style="background-color: #00933D; height: 10px;"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 text-center">
                <div style="background-color: #212121; padding-top: 15px; width: 96%; margin-left: 2%;">
                    ...
                    <div class="row text-center" style="margin-top: 15px; padding-bottom: 10px">
                        <a style="text-decoration: none;" href=""><span style="color:white; font-size:9px; ">Privacy Policy</span></a>
                        <span style="color:white; font-size:9px;">|</span>
                        <a style="text-decoration: none;" href=""><span style="color:white; font-size:9px; text-decoration: none;">Terms and Conditions</span></a>
                        <span style="color:white; font-size:9px;">|</span>
                        <a style="text-decoration: none;" href=""><span style="color:white; font-size:9px; text-decoration: none;">Contact us</span></a>
                    </div>            
                </div>           
            </div>            
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div style="background-color: #00933D; padding-top: 15px; padding-bottom: 5px">
                    <div class="row">
                        ...
                        <div class="col-sm-1 text-center" style="padding-left: 0px; margin-top: 20px">
                            <a href=""><img src="images/Logo Curacao.png" style="padding-right: 15px"></a>
                        </div>  
                    </div>
                </div>           
            </div>            
